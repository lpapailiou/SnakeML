...
public class ManualAgent extends Agent {
   ...
   * It will initialize a new game, provide it to the state instance, and
   * plainly execute steps of a game by reading the according direction from the state instance.
   */
  @Override
  public void build() {
    super.build();
