...
public class GameInformationPainter {
  ...
  private final double fontSizeLarge = 32;
  ...
  public void paint(GenerationEntity entity, int snakeLength, int position) {
    ...
    switch (position) {
      ...
      case 1:
        ...
        context.fillText("death by wall:   \t\t" + (int) (100/deathcount*deathWall) + " %", offsetX+padding, y+90);
        context.fillText("death by body:   \t\t" + (int) (100/deathcount*deathBody) + " %", offsetX+padding, y+110);
        context.fillText("death by timeout:   \t\t" + (int) (100/deathcount*deathTimeout) + " %", offsetX+padding, y+130);
