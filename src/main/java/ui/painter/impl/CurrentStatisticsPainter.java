...
public class CurrentStatisticsPainter {
  ...
  private final double offsetX = 40;
  private final double offsetY = (canvasWidth-offsetX)-120;
  ...
  public void paint(GenerationEntity entity) {
    ...
    background = background.deriveColor(1,1,1,0.5);
    context.setFill(background);
    context.fillRoundRect(offsetX, offsetY, 200, 120, 6, 6);
